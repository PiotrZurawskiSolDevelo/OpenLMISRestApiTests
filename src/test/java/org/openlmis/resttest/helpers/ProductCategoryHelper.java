...
public class ProductCategoryHelper extends AbstractRestHelper {

    public ProductCategoryHelper(String baseUrl) {
        super(baseUrl, "/api/productCategories");
    }

    public JsonNode createProductCategory(String token, String jsonBody) throws IOException {
